...
SELECT LEN(REPLACE('                                       ...than this',' ',''))--11

--PATINDEX
SELECT PATINDEX('%ern%', 'SQL Pattern Index') pos

SELECT CHARINDEX('ern', 'SQL Pattern Index') pos
...
SELECT REPLACE(REVERSE(
    'evil ot sah eh|hcihw ni|pmaws a ylno sa|nam a fo skniht|mreg a tub|nem ot elbanoitcejbo|yrev era smreg'),'|',' '
	)
